                            ...
                            <div class="menu-wrap">
                                <nav class="menu-nav show">
                                    ...
                                    <div class="navbar-wrap main-menu d-none d-lg-flex">
                                        <ul class="navigation">
                                            <li class="menu-item-has-children"><a href="index-2">Home</a></li>
                                            ...
                                            <li><a href="video-pricing">Pricing</a></li>
                                    ...
                                    <div class="header-action d-none d-md-block">
                                        <ul>
                                            ...
                                            <li class="header-btn"><a href="user-login" class="btn">Login</a></li>
                                            <li class="header-btn"><a href="user-register" class="btn">Register</a></li>
                                        </ul>
                                    </div>
                                </nav>
                            </div>
